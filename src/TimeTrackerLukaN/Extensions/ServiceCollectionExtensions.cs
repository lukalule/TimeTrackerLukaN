...
namespace TimeTrackerLukaN.Extensions
{
                        ...
                        new SecurityDefinitionAppender(
                            "jwt-token", new[] { "" }, new OpenApiSecurityScheme
                            {
                                ...
                                Description =
                                    ...
                                    "Use https://localhost:44365/get-token to get read-only JWT token. " +
                                    "Use https://localhost:44365/get-token?admin=true to get admin (read-write) JWT token.",
